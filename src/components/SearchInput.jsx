...
const SearchInput = () => {
  ...
  return (
    <div className="h-[46px] w-full md:w-[570px] flex items-center px-4 gap-3 border border-[#dfe1e5] rounded-3xl hover:bg-white hover:border-0 focus-within:shadow-c focus-within:border-0">
